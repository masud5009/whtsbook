...
@section('content')
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @php
                                                            ...
                                                            $diff = (int) $createDate->diffInDays($todayDate);
                                                        @endphp
                                                    ...
                                                    <td>
                                                        <a class="btn btn-secondary btn-sm mr-1 editBtn mb-1" href="#"
                                                            ...
                                                            data-start_date="{{ date_format($startDate, 'Y-m-d') }}"
                                                            data-end_date="{{ date_format($endDate, 'Y-m-d') }}"
                                                        ...
                                                        <form class="deleteForm d-inline-block"
                                                            action="{{ route('tenant.rooms_management.delete_coupon', ['id' => $coupon->id]) }}"
                                                            method="post">
                                                            @csrf
                                                            <button type="submit"
    ...
    {{-- create modal --}}
    @includeIf('user.rooms.create_coupon')

    {{-- edit modal --}}
    @includeIf('user.rooms.edit_coupon')
@endsection
