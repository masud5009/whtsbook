                                                            ...
                                                            <div class="dropdown-menu">
                                                                @if (Auth::guard('admin')->user()->id == 1)
                                                                    @if ($ticket->admin_id == 1)
                                                                        <a class="dropdown-item click-modal-staff"
                                                                            href="{{ $ticket->id }}" data-toggle="modal"
                                                                            data-target="#assignModal">{{ __('Assign To') }}</a>
                                                                    @else
                                                                        @if (Auth::guard('admin')->user()->id == 1)
                                                                            <a class="dropdown-item click-modal-staff"
                                                                                href="javascript:;"><span
                                                                                    class="badge badge-success">{{ __('Assigned To') }}
                                                                                    {{ $ticket->admin->username }}</span></a>
                                                                        @endif
                                                                    @endif
