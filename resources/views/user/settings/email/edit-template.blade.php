                    ...
                    <div class="row">
                        <div class="col-lg-7">
                            <form id="mailTemplateForm"
                                action="{{ route('user.update_mail_template', ['id' => $templateInfo->id]) }}"
                                method="post">
                                @csrf
                                <div class="row">
                                    <div class="col-lg-12">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control summernote" name="mail_body" placeholder="{{ __('Enter Mail Body') }}" data-height="300"
                                                id="summernote">{{ replaceBaseUrl($templateInfo->mail_body, 'summernote') }}</textarea>
