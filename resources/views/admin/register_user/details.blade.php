...
@section('content')
    <div class="page-header">
        ...
        <ul class="breadcrumbs">
            ...
            <li class="nav-item">
                <a href="#">{{ __('Register Users') }}</a>
            </li>
            <li class="separator">
                <i class="flaticon-right-arrow"></i>
            </li>
            <li class="nav-item">
                <a href="="{{ route('admin.register.user') }}">{{ __('Users') }}</a>
            </li>
            <li class="separator">
                <i class="flaticon-right-arrow"></i>
            </li>
        ...
        <div class="col-md-3">
            <div class="card">
                <div class="card-body text-center p-4">
                    <img src="{{ !is_null($user->photo) ? asset('assets/tenant/img/users/' . $user->photo) : asset('assets/tenant/image/profile.jpg') }}"
        ...
        <div class="col-md-9">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-3">
                        <div class="col-lg-6">
                            <strong>{{ __('Path Based URL') . __(':') }}</strong>
                        </div>
                        <div class="col-lg-6">
                    ...
                    <div class="row mb-3">
                        <div class="col-lg-6">
                            <strong>{{ __('Current Package') . __(':') }}</strong>
                        </div>
                        <div class="col-lg-6">
                            @if ($currPackage)
                                <a target="_blank"
                    ...
                    <div class="row mb-3">
                        <div class="col-lg-6">
                            <strong>{{ __('Next Package') . __(':') }}</strong>
                        </div>
                        <div class="col-lg-6">
                            @if ($nextPackage)
                                <a target="_blank"
