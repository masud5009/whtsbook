                                ...
                                <div class="form-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12 showImage mb-3">
                                            <img src="{{ !empty(Auth::guard('admin')->user()->image) ? asset('assets/admin/img/propics/' . Auth::guard('admin')->user()->image) : asset('assets/admin/img/noimage.jpg') }}"
                                                alt="..." class="img-thumbnail">
                                        </div>
                                        <div class="col-12">
                                            <div role="button" class="btn btn-primary btn-sm upload-btn px-3 py-2"
                                                id="image">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input class="form-control input-lg" name="username"
                                                value="{{ $admin->username }}" placeholder="{{ __('Your Username') }}"
                                                type="text">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input class="form-control input-lg" name="email" value="{{ $admin->email }}"
                                                placeholder="{{ __('Your Email') }}" type="text">
                                            @if ($errors->has('email'))
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input class="form-control input-lg" name="first_name"
                                                value="{{ $admin->first_name }}" placeholder="{{ __('Your First Name') }}"
                                                type="text">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input class="form-control input-lg" name="last_name"
                                                value="{{ $admin->last_name }}" placeholder="{{ __('Your Last Name') }}"
                                                type="last_name">
