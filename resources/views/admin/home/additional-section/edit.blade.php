                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-8 mx-auto">
                            ...
                            <form id="pageForm" action="{{ route('admin.additional_section.update', $section->id) }}"
                                method="POST">
                                @csrf
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group p-0">
                                            ...
                                            <select name="possition" class="form-control select2">
                                                ...
                                                @foreach ($all_sections as $c_section)
                                                    <option value="{{ $c_section }}" @selected($c_section == $section->possition)>
                                                        {{ __('After ' . str_replace('_', ' ', $c_section)) }}</option>
                                                @endforeach
                                    ...
                                    @foreach ($languages as $language)
                                        <div class="version">
                                            <div class="version-header" id="heading{{ $language->id }}">
                                                <h5 class="mb-0">
                                                    <button type="button"
                                                        class="btn btn-link {{ $language->rtl == 1 ? 'rtl text-right' : '' }}"
                                            ...
                                            @php
                                                $content = App\Models\AdditionalSectionContent::where(
                                                    'addition_section_id',
                                                    $section->id,
                                                )
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-12">
                                                            <div
                                                                ...
                                                                <label>{{ __('Name') }} <span
                                                                        class="text-danger">**</span></label>
                                                                <input type="text" class="form-control {{ $language->rtl == 1 ? 'rtl text-right' : '' }}"
