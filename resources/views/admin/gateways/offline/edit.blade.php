    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="ajaxEditForm" class="" action="{{ route('admin.gateway.offline.update') }}"
                    method="POST">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input id="in_serial_number" type="number" class="form-control ltr"
                                    name="serial_number" value="" placeholder="{{ __('Enter Serial Number') }}">
