    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="ajaxForm" class="modal-form" action="{{ route('admin.gateway.offline.store') }}"
                    method="POST">
                    @csrf
                    <div class="row">
                        <div class="col-lg-12">
                    ...
                    <div class="form-group">
                        ...
                        <p id="err_short_description" class="mb-0 text-danger em"></p>
                    </div>

                    <div class="form-group">
                        <label for="">{{ __('Instructions') }}</label>
                        <textarea class="form-control summernote" id="summernote" name="instructions" rows="3" cols="80"
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <p class="text-warning">
                                    <small>{{ __('The higher serial number is, the later the package will be shown everywhere.') }}</small>
                                </p>
                            </div>
                        </div>
                    </div>
