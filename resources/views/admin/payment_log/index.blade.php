                    ...
                    <tbody>
                      @foreach ($memberships as $key => $membership)
                        <tr>
                          ...
                          <td>
                            {{ !empty($membership->package) ? $membership->package->title : '' }}
                          </td>
                          <td>
                            <a
                          ...
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                ...
                                <label>{{ __('Name') }}</label>
                                <p>
                                  {{ !empty($membership->user) ? $membership->user->first_name . ' ' . $membership->user->last_name : '-' }}
                                </p>
                                ...
                                <p>{{ !empty($membership->user->phone_number) ? $membership->user->phone_number : '-' }}
                                </p>
                                <h3 class="text-warning">{{ __('Payment details') }}</h3>
                                <p><strong>{{ __('Package Price') }}: </strong> {{ format_price($membership->package_price) }}
                                </p>
                                @if ($membership->discount > 0)
                                  <p><strong>{{ __('Discount') }}: </strong> {{ format_price($membership->discount) }}
                                  </p>
                                  <p><strong>{{ __('Total') }}: </strong> {{ format_price($membership->price) }}
                                  </p>
                                @endif
