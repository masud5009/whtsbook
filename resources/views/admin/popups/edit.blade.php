                            ...
                            <form id="ajaxForm" class="modal-form" action="{{ route('admin.popup.update') }}"
                                ...
                                @if ($type == 1 || $type == 4 || $type == 5 || $type == 7)
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12 showImage mb-3 pl-0">
                                            <img src="{{ $popup->image ? asset('assets/front/img/popups/' . $popup->image) : asset('assets/admin/img/noimage.jpg') }}"
                                        ...
                                        @if ($type == 1)
                                            <p class="text-warning mb-0">
                                                {{ __('Upload 960 X 600 image for best quality') }}</p>
                                        @elseif ($type == 2 || $type == 3)
                                            <p class="text-warning mb-0">
                                                {{ __('Upload 1145 X 765 image for best quality') }}</p>
                                        @elseif ($type == 4 || $type == 5)
                                            <p class="text-warning mb-0">
                                                {{ __('Upload 517 X 689 image for best quality') }}</p>
                                        @elseif ($type == 6)
                                            <p class="text-warning mb-0">
                                                {{ __('Upload 960 X 660 image for best quality') }}</p>
                                        @elseif ($type == 7)
                                            <p class="text-warning mb-0">
                                                {{ __('Upload 550 X 765 image for best quality') }}</p>
                                        @endif
                                    </div>
                                @endif
                                ...
                                @if ($type == 2 || $type == 3 || $type == 6)
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12 showImage2 pl-0">
                                            <img src="{{ $popup->background_image ? asset('assets/front/img/popups/' . $popup->background_image) : asset('assets/admin/img/noimage.jpg') }}"
                                                alt="..." class="img-thumbnail">
                                        </div>
                                        <br>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <label for="">{{ __('Popup Name') }} <span
                                                    class="text-danger">**</span></label>
                                            <input type="text" class="form-control" name="name"
                                                value="{{ $popup->name }}" placeholder=" {{ __('Enter Name') }}">
                                            <p class="text-warning mb-0">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="title"
                                                    value="{{ $popup->title }}" placeholder="{{ __('Enter Title') }}">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control ltr timepicker" name="end_time"
                                                    value="{{ $popup->end_time }}"
                                                    placeholder="{{ __('Enter End Time') }}" autocomplete="off">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <ul class="mb-0">
                                                    <li class="text-warning mb-0">{{ __('Value must be between 0 to 1') }}
                                                    </li>
                                                    <li class="text-warning mb-0">
                                                        {{ __('The more the opacity value is, the less the trnsparency level will be') }}
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                ...
                                <div class="form-group">
                                    <label for="">{{ __('Delay') }} ({{ __('miliseconds') }}) <span
                                            class="text-danger">**</span></label>
                                    <input type="number" class="form-control ltr" name="delay"
                                        value="{{ $popup->delay }}" placeholder="{{ __('Enter Delay') }}">
                                    <p id="err_delay" class="mb-0 text-danger em"></p>
                                    <p class="text-warning mb-0">
                                        {{ __('This will decide the delay time to show the popup') }}</p>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <ul>
                                        <li class="text-warning mb-0">{{ __('If there have') }} <strong
                                                class="text-info">{{ __('Multiple Active Popups') }}</strong>,
                                            {{ __('then the popups will be shown in the website according to') }} <strong
                                                class="text-info">{{ __('Serial Number') }}</strong></li>
                                        <li class="text-warning">
                                            {{ __('The higher the serial number, the later the popups will be visible in Website') }}
                                        </li>
                                    </ul>
                                </div>
