                            ...
                            <form id="ajaxForm" class="modal-form" action="{{ route('admin.popup.store') }}" method="post"
                                ...
                                @if ($type == 2 || $type == 3 || $type == 6)
                                    ...
                                    <div class="form-group">
                                        ...
                                        <p class="mb-0 text-warning">{{ __('Only png, jpg, jpeg image is allowed') }}</p>
                                        <p id="err_background_image" class="mb-0 text-danger em"></p>
                                    </div>
                                @endif
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control ltr datepicker" name="end_date"
                                                    value="" placeholder="{{ __('Enter End Date') }}" readonly
                                                    autocomplete="off">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control ltr timepicker" name="end_time"
                                                    value="" placeholder="{{ __('Enter End Time') }}" readonly
                                                    autocomplete="off">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control jscolor ltr"
                                                    name="button_color" value="451d53"
