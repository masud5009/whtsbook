                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-6 mt-2 mt-lg-0">
                            <button class="mb-1 btn btn-danger float-right btn-sm ml-2 d-none bulk-delete"
                            ...
                            <form action="{{ url()->full() }}" class="float-right">
                                <input type="text" name="term" class="form-control"
                                    value="{{ request()->input('term') }}" placeholder="{{ __('Search by Email') }}">
                            </form>
                        </div>
                    </div>
                </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <form class="deleteform d-inline-block"
                                                            action="{{ route('admin.subscriber.delete') }}" method="post">
                                                            @csrf
