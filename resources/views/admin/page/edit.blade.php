...
@section('content')
    <div class="page-header">
        ...
        <ul class="breadcrumbs">
            ...
            <li class="nav-item">
                <a
                    href="{{ route('admin.page.index') . '?language=' . request()->input('language') }}">{{ __('All Pages') }}</a>
            </li>
            <li class="separator">
                <i class="flaticon-right-arrow"></i>
            </li>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name" class="form-control"
                                                placeholder="{{ __('Enter Name') }}" value="{{ $page->name }}">
                                            <p id="err_name" class="em text-danger mb-0"></p>
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="title"
                                                placeholder="{{ __('Enter Title') }}" value="{{ $page->title }}">
                                            <p id="err_title" class="em text-danger mb-0"></p>
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <p id="err_status" class="em text-danger mb-0"></p>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <p id="err_body" class="em text-danger mb-0"></p>
                                </div>
                                <div class="form-group">
