                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a class="btn btn-secondary btn-sm editbtn mb-1" href="#editModal"
                                                            data-toggle="modal" data-faq_id="{{ $faq->id }}"
                ...
                <div class="modal-body">
                    <form id="ajaxForm" class="modal-form create" action="{{ route('admin.faq.store') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <p id="err_question" class="mb-0 text-danger em"></p>
                        </div>
                        <div class="form-group">
                            ...
                            <p id="err_answer" class="mb-0 text-danger em"></p>
                        </div>
                        <div class="form-group">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="ajaxEditForm" class="" action="{{ route('admin.faq.update') }}" method="POST">
                        @csrf
                        <input id="in_faq_id" type="hidden" name="faq_id" value="">
                        <div class="form-group">
                            <label for="">{{ __('Question') }} <span class="text-danger">**</span></label>
                            <input id="in_question" type="text" class="form-control" name="question" value=""
                                placeholder="{{ __('Enter Question') }}">
                            <p id="editErr_question" class="mb-0 text-danger em"></p>
                        </div>
                        <div class="form-group">
                            <label for="">{{ __('Answer') }} <span class="text-danger">**</span></label>
                            <textarea id="in_answer" class="form-control" name="answer" rows="5" cols="80"
                                placeholder="{{ __('Enter Answer') }}"></textarea>
                            <p id="editErr_answer" class="mb-0 text-danger em"></p>
                        </div>
                        <div class="form-group">
                            <label for="">{{ __('Serial Number') }} <span class="text-danger">**</span></label>
