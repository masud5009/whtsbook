<table class="table table-striped mb-5 bbcodes-table border">
    ...
    <tbody>
        ...
        @endif
        @if ($templateInfo->email_type != 'email_verification' || $templateInfo->email_type == 'withdraw_approve')
            <tr>
                <td>
                    {username}
                </td>
        ...
        @endif
        @if ($templateInfo->email_type == 'token_purchase_success' || $templateInfo->email_type == 'token_purchase_pending'
        || $templateInfo->email_type == 'token_purchase_rejected')
            <tr>
                <td>
                    {token_amount}
                </td>
