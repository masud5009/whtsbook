        ...
        <div class="header">
            <div class="ml-20">
                <table class="text-left">
                    ...
                    <tr>
                        <td class="strong gry-color">{{ucfirst($member["first_name"]).' '.ucfirst($member["last_name"])}}</td>
                    </tr>
                    <tr>
            ...
            <div class="order-details">
                <table class="text-right">
                    ...
                    <tr>
                        <td class="gry-color small"><strong>Package Price :</strong> {{$membership->package_price == 0 ? "Free": format_price($membership->package_price)}}</td>
                    </tr>
                    <tr>
                    ...
                    @endif
                    <tr>
                        <td class="gry-color small"><strong>Total :</strong> {{$amount == 0 ? "Free": format_price($amount)}}</td>
                    </tr>
                    <tr>
        ...
        <div class="package-info">
            <table class="padding text-left small border-bottom">
                ...
                <tr class="text-center">
                    ...
                    <td>
                        <span style="color:#000">{{$base_currency_text}} </span>
                    </td>
                    <td>
                        {{$amount == 0 ? "Free": format_price($amount)}}
                    </td>
                </tr>
                </tbody>
            </table>
