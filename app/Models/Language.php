...
{
    protected $fillable = ['id', 'name', 'is_default', 'code', 'rtl','dashboard_default'];
    ...
    public function hero_sliders() {
        return $this->hasMany('App\Models\HeroSlider');
    }

    public function platform_modules() {
        return $this->hasMany('App\Models\PlatformModule');
    }

    public function about_gallery_images() {
        return $this->hasMany('App\Models\AboutGalleryImage');
    }
}
