...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'throttle.webhook' => \App\Http\Middleware\ThrottleWebhook::class,
        'verified' => \Illuminate\Auth\Middleware\EnsureEmailIsVerified::class,
        'checkpermission' => \App\Http\Middleware\CheckPermission::class,
        'setlang' => \App\Http\Middleware\SetLangMiddleware::class,
        'setUserLang' => \App\Http\Middleware\SetUserDashboardMiddleware::class,
        ...
        'adminLang' => \App\Http\Middleware\CheckAdminLanguage::class,
        'tenantStaffAccess' => \App\Http\Middleware\TenantStaffAccess::class,
    ];
